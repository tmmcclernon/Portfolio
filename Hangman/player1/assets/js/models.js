...
var hangman = {
    ...
    sendP1StatsToP2 : function(){
        ...
        $.getJSON("http://127.0.0.1:3000/player1",{playerName,score,gameState,wins,losses},function(data){
        
        
    });
    console.log(" p1 assets P1->P2 request sent")
},
